...
class Predictor:
    ...
    def from_model_registry(
        ...
        # Steps:
        1. Fetch the model artifact from the model registry
        2. Fetch the relevant metadata from the model registry
        3. Return a Predictor object with the model artifact and metadata
    ...
    def predict(self) -> PredictorOutput:
        ...
        Steps:
        1. Fetch the latest OHLC data from the feature store
        2. Preprocess the data (interpolate missing candles).
        Need to follow the same preprocessing steps as in training
